        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="w-full h-48 bg-gradient-to-br from-primary-400 to-purple-500 rounded-lg mb-6 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                <svg
